...
var _lodash5 = require('lodash.omitby');
...
function nodeToJson(node) {
    ...
    var children = (0, _lodash2.default)((0, _ShallowTraversal.childrenOfNode)(node).map(function (n) {
        return nodeToJson(n);
    }));
    var type = (0, _Debug.typeName)(node);
    var props = (0, _lodash6.default)((0, _Utils.propsOfNode)(node), function (val, key) {
