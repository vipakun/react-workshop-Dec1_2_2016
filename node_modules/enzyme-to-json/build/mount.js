...
exports.mountToJson = mountToJson;
...
function instToJson(inst) {
    ...
    var props = (0, _lodash4.default)((0, _Utils.propsOfNode)(currentElement), function (val, key) {
    ...
    var childrenArray = (0, _lodash2.default)(children.map(function (n) {
        return instToJson(n);
    }));
